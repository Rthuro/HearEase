    ...
    <section className='flex flex-col items-center w-fit mx-auto relative'>
     <div className="flex flex-col items-center gap-6">
        <div className="flex items-center gap-2">
            <p className='text-2xl md:text-4xl font-medium'>Making <span className='text-redBase'>Hearings</span> Easier</p>
            <img src={Energy} alt="Energy" className="h-8 md:h-10" />
          </div>
          <p className='text-zinc-700 max-w-full px-4 md:px-0 md:max-w-[640px] text-center'>
