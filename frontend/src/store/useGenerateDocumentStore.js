        ...
        switch (template_name) {
            case 'summon':
                formData = {
                    ...
                    lupon_member: recentHearing?.lupon_member_name || 'N/A',
            ...
            case 'cancellation':
                formData = {
                    ...
                    next_hearing_date: case_hearings.find( c => c.hearing_status === 'scheduled' || c.hearing_status == 'rescheduled')?.hearing_date || 'N/A',
                    cancellation_reason: case_data.remarks || 'N/A',
                }
                break;
            case 'court':
                 formData = {
