...
export function CaseForm() {
    const { formData, addCaseData, fetchCaseTypes, fetchSettlementTypes, complainantList, respondentList, setComplainantInfo, set_complainants, jurisdictionWarning } = useCaseStore();
