...
import { CalendarDaysIcon, HandshakeIcon, File, CalendarIcon } from "lucide-react";
...
export function HearingProgressDisplay({ hearing, case_complainants, case_respondents, case_organization_complainants, case_organization_respondents }) {
    ...
    const [ type, setType ] = useState("amicable");
   ...
   return (
    <div className="flex flex-col gap-6 p-4 border-redBase border-t-8 bg-white shadow-md rounded-md">
        ...
        <div className="flex flex-col gap-4 p-4 border bg-gray-50 rounded-md">
            ...
            <div className={ outcome !== null ?"flex py-6 px-8 border rounded-md bg-white shadow-inner" : "hidden"}>
                { outcome === 1 && (
                    <div className="flex flex-col gap-4 border-l-4 border-blue-800 pl-4 w-full">
                        ...
                        <Button className=" bg-blue-800 hover:bg-blue-600" >Save Hearing</Button>
                    </div>
                )}
                { outcome === 2 && (
                      <div className="flex flex-col gap-4 border-l-4 border-green-800 pl-4 w-full">
                            ...
                            >
                                ...
                                <SelectContent>
                                    <SelectGroup>
                                        ...
                                        <SelectItem value="arbitration">Arbitration Settlement</SelectItem>
                                    </SelectGroup>
                                </SelectContent>
                            </Select> 
                        </div>
                        ...
                        <Button className=" bg-green-800 hover:bg-green-600" >Mark as Settled</Button>
                    </div>
                )}
                { outcome === 3 && (
                    <div className="flex flex-col gap-4 border-l-4 border-redBase pl-4 w-full">
                        ...
                        <Button className=" bg-redBase hover:bg-redBase/90" >Generate CFA</Button>
